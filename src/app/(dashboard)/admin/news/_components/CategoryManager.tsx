...
import { NewsCategory, NewsService } from "@/services/news.service";
...
export default function CategoryManager() {
    ...
    const [currentCategory, setCurrentCategory] = useState<Partial<NewsCategory>>({ name: "" });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isEditing && currentCategory.id) {
                await NewsService.updateCategory(currentCategory.id, currentCategory);
            } else {
                await NewsService.createCategory(currentCategory);
            }
